...
print(
    "invert rows",
    invert_rows_arr.shape,
    invert_rows_arr.strides,
...
print(
    "invert columns",
    invert_cols_arr.shape,
    invert_cols_arr.strides,
...
print("rot_arr", rot_arr.shape, rot_arr.strides, np.shares_memory(rot_arr, image_arr))
